...
cat $in | /home/aires/personal_work_troja/marian_exp/marian-cpu/build/marian-decoder -c /home/aires/personal_work_troja/style_transfer/marian_models/model_enfr_baseline/model.npz.decoder.yml > $in.fr_baseline
# translate test set
