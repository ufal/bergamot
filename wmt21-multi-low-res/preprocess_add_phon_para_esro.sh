...
rm -f euro_low_res_multiling/data/lang_pairs/all_text.any-any.cln.grap+phon.src

for pair in es-oc  es-ro  fr-it  fr-oc  fr-ro ca-en  ca-es  ca-fr  ca-pt  en-it  en-oc  en-ro
do
echo $pair
cd $pair
...
parts=24
split -d -n l/$parts all_text.$src_lang-$tgt_lang.cln.$src_lang parts/all_text.$src_lang-$tgt_lang.cln.$src_lang.part
for p in {00..23}
do
python -u ../../../../phonemize.py $src_lang < parts/all_text.$src_lang-$tgt_lang.cln.$src_lang.part$p  > parts/all_text.$src_lang-$tgt_lang.cln.$src_lang.part$p.phon  &
done
wait
cat parts/all_text.$src_lang-$tgt_lang.cln.$src_lang.part{00..23}.phon > all_text.$src_lang-$tgt_lang.cln.$src_lang.phon
