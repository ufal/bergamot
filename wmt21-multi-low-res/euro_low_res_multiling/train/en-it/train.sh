...
cd /lnet/express/work/people/jon/wmt21/euro_low_res_multiling/train/en-$tgt_lang
$marian/marian \
	--model model/model.en-$tgt_lang.npz  --type transformer \
    --train-sets ../../data/add_resources/en-$tgt_lang/all_text.en-$tgt_lang.cln.en.sp ../../data/add_resources/en-$tgt_lang/all_text.en-$tgt_lang.cln.$tgt_lang.sp  \
    --max-length 150 \
    ...
    --valid-sets newstest09.en.sp newstest09.it.sp \
