...
$marian/marian \
	--model model/model.any-ocroit.norm_src_phon_tgt.npz  --type transformer \
    --train-sets ../../data/add_resources/all_text.any-ocroit.cln.src ../../data/add_resources/all_text.any-ocroit.cln.graph+phon.tgt  \
    --max-length 350 \
    ...
    --log model/norm_src_phon_tgt.log --valid-log model/valid.log \
