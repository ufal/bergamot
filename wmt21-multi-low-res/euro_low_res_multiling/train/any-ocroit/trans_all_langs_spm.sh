...
cat ../ca-oc/wp.dev.ca.snt | bash ../../../add_tags.sh oc |  $marian/marian-decoder -c $1 --cpu-threads 32 -n 1.0 -b 8 > $2_oc
cat ../ca-oc/wp.dev.ca.snt | bash ../../../add_tags.sh it |  $marian/marian-decoder -c  $1 --cpu-threads 32 -n 1.0 -b 8 > $2_it
cat ../ca-oc/wp.dev.ca.snt | bash ../../../add_tags.sh ro |  $marian/marian-decoder -c  $1 --cpu-threads 32 -n 1.0 -b 8 > $2_ro
...
cat ../any-any/wp.test.ca.snt | bash ../../../add_tags.sh oc |  $marian/marian-decoder -c $1 --cpu-threads 32 -n 1.0 -b 8 > $2_oc
cat ../any-any/wp.test.ca.snt | bash ../../../add_tags.sh it |  $marian/marian-decoder -c  $1 --cpu-threads 32 -n 1.0 -b 8 > $2_it
cat ../any-any/wp.test.ca.snt | bash ../../../add_tags.sh ro |  $marian/marian-decoder -c  $1 --cpu-threads 32 -n 1.0 -b 8 > $2_ro
