...
$marian/marian \
	--model model/model.any-ocroit.spm.npz  --type transformer \
    ...
    --log model/train_spm.log --valid-log model/valid.log \
    ...
    --devices 0 1 2 3  --sync-sgd --seed 1111 --sqlite -T  /lnet/depot/jon/ \
