...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.wikibt.from_scratch.big.npz --type transformer --task transformer-big \
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt.ca-$tgt_lang.cln.ca.sp  ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt.ca-$tgt_lang.cln.$tgt_lang.sp  \
    --max-length 450 \
    ...
    --log model/train_chars_wikibt_from_scratch.big.log --valid-log model/valid.log \
     --keep-best \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --tied-embeddings-all --optimizer-delay 1 \
    --devices 0 1 2 3 4 5 6 7  --sync-sgd --seed 1111 --sqlite -T  /mnt/h/tmp \
