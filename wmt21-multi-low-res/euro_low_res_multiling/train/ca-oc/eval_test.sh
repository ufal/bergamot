...
cat ../any-any/test.snt  | bash trans_2k_params.sh -c model/$model -d 0  -b 8 -n 1.0 --mini-batch 8 > test.out
cat test.out | sacrebleu -m bleu chrf -w 4 ../any-any/wp.test."$lang".snt > test_results/"$model"_test_bleu_2k
