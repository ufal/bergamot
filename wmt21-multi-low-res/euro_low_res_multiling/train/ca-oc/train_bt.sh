...
$marian/marian \
	--model model/model.ca-$tgt_lang.bt.npz	--pretrained-model model/model.ca-$tgt_lang.npz  --type transformer \
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text+bt.ca-$tgt_lang.cln.ca.sp ../../data/lang_pairs/ca-$tgt_lang/all_text+bt.ca-$tgt_lang.cln.$tgt_lang.sp  \
    --max-length 150 \
    ...
    --log model/train_bt.log --valid-log model/valid.log \
