...
$marian/marian \
	--model model/model.ca-$tgt_lang.bt.balanced.npz	--pretrained-model model/model.ca-$tgt_lang.npz  --type transformer \
    ...
    --log model/train_bt_balanced.log --valid-log model/valid.log \
