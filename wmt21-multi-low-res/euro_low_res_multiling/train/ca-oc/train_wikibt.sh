...
$marian/marian \
	--model model/model.ca-$tgt_lang.wikibt.npz	--pretrained-model model/model.ca-$tgt_lang.npz  --type transformer \
    ...
    --log model/train_bt_wiki.log --valid-log model/valid.log \
