...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.finetune.any-any.big.npz --pretrained-model ../any-any/model/model.any-any.big.npz  --type transformer --task transformer-big \
    ...
    --log model/train_chars_finetune_any-any.big.log --valid-log model/valid.log \
     --keep-best \
