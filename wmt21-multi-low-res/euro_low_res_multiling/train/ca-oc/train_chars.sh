...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.npz --pretrained-model model/model.ca-$tgt_lang.npz  --type transformer \
    ...
    --log model/train_chars.log --valid-log model/valid.log \
