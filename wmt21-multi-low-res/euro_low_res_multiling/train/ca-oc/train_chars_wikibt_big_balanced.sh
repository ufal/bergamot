...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.wikibt.from_scratch.big.balanced.npz --pretrained-model  model/model.ca-oc.big.wikbt.bt.chars.from.scratch.npz --type transformer --task transformer-big \
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt+bt.balanced.ca-oc.cln.ca.chars  ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt+bt.balanced.ca-oc.cln.$tgt_lang.chars \
    --max-length 450 \
    ...
    --log model/train_chars_wikibt_from_scratch.big.balanced.log --valid-log model/valid.log \
     --keep-best \
