...
$marian/marian \
	--model model/model.ca-$tgt_lang.big.wikbt.bt.chars.from.scratch.npz  --type transformer --task transformer-big\
    ...
    --log model/train_big_chars_from_scratch.log --valid-log model/valid.log \
     --keep-best \
