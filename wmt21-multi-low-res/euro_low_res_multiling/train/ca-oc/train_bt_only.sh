...
$marian/marian \
	--model model/model.ca-$tgt_lang.bt_only.npz	 --type transformer \
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/bt_apertium.oc_to_ca.sp ../../data/lang_pairs/ca-$tgt_lang/bt_apertium.oc.sp  \
    --max-length 150 \
    ...
    --log model/train_bt_only.log --valid-log model/valid.log \
