...
cp ../any-any/model/model.any-any.big.npz model/model.ca-$tgt_lang.chars.wikibt.finetune.continued.any-any.big.npz
cp ../any-any/model/model.any-any.big.npz model/model.ca-$tgt_lang.chars.wikibt.finetune.continued.any-any.big.npz.orig.npz

cp ../any-any/model/model.any-any.big.npz.optimizer.npz model/model.ca-$tgt_lang.chars.wikibt.finetune.continued.any-any.big.npz.optimizer.npz
cp ../any-any/model/model.any-any.npz.progress.yml model/model.ca-$tgt_lang.chars.wikibt.finetune.continued.any-any.big.progress.yml
...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.wikibt.finetune.continued.any-any.big.npz --type transformer --task transformer-big \
    ...
    --log model/train_chars_wikibt_finetune_continued_any-any.big.log --valid-log model/valid.log \
     --keep-best \
