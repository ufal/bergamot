...
$marian/marian \
	--model model/model.ca-$tgt_lang.fakebt.npz  --type transformer \
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text.ca-oc.cln.oc_trans_to_ca.sp ../../data/lang_pairs/ca-$tgt_lang/all_text.ca-$tgt_lang.cln.$tgt_lang.sp  \
    --max-length 150 \
    ...
    --log model/train.fakebt.log --valid-log model/valid.log \
