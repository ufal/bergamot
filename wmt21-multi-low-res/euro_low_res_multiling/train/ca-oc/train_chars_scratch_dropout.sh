...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.from.scratch.dropout.npz  --type transformer \
    ...
    --log model/train_chars_from_scratch.dropout.log --valid-log model/valid.log \
    --enc-depth 6 --dec-depth 6 \
    --transformer-heads 8 --keep-best \
    --transformer-postprocess-emb d \
    --transformer-postprocess dan \
    --transformer-dropout 0.3 --transformer-dropout-ffn 0.3 --label-smoothing 0.1 \
