...
$marian/marian \
	--model model/model.ca-$tgt_lang.phon.chars.pre.2.npz --pretrained-model model/model.ca-$tgt_lang.phon.npz  --type transformer \
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text.ca-oc.cln.ca.phon.phonsp.chars ../../data/lang_pairs/ca-$tgt_lang/all_text.ca-oc.cln.oc.chars  \
    --max-length 450 \
    --vocabs corp/vocab.phon.yml corp/vocab.phon.yml \
    ...
    --valid-sets wp.dev.ca.phonsp.chars wp.dev.oc.phonsp.chars \
    --valid-translation-output data/valid.update{U}.output \
    --valid-mini-batch 16  \
    --beam-size 4 --normalize 1 \
    --log model/train_phon_chars_pre.log --valid-log model/valid.log \
