...
$spm/spm_encode --model ../../data/add_resources/any-any.model  | $marian/marian-decoder -c $1 --n-best -b 20 -n 2.9 -d 0 1 2 3 | $spm/spm_decode --model ../../data/add_resources/any-any.model
