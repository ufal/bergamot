...
tgt_lang=oc
$spm/spm_encode --model ../../data/lang_pairs/ca-$tgt_lang/ca-$tgt_lang.2k.model | $marian/marian-decoder "$@"  | $spm/spm_decode --model ../../data/lang_pairs/ca-$tgt_lang/ca-$tgt_lang.2k.model
