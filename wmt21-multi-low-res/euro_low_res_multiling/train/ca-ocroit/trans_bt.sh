...
$spm/spm_encode --model ../../data/lang_pairs/ca-any.model  | $marian/marian-decoder -c model/model.any-ca.npz.best-bleu-detok.npz.decoder.yml | $spm/spm_decode --model ../../data/lang_pairs/ca-any.model
