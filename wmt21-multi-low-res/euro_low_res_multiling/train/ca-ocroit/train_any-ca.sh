...
$marian/marian \
	--model model/model.any-ca.npz  --type transformer \
    --train-sets ../../data/lang_pairs/all_text.ca-any.cln.any.sp ../../data/lang_pairs/all_text.ca-any.cln.ca.sp  \
    --max-length 150 \
