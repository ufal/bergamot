...
$marian/marian \
    ...
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt.ca-$tgt_lang.cln.ca.anyanysp  ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt.ca-$tgt_lang.cln.$tgt_lang.anyanysp  \
    --max-length 150 \
    ...
    --valid-sets wp.dev.ca.anyanysp wp.dev.$tgt_lang.anyanysp \
