...
$marian/marian \
	--model model/model.ca-$tgt_lang.from.en-fr.orig.vocab.npz --pretrained-model model/model.enfr.similar_sp.npz.best-bleu-detok.npz --type transformer \
    ...
    --log model/train_orig.log --valid-log model/valid.log \
