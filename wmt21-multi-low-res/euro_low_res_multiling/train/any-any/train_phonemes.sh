...
$marian/marian \
	--model model/model.any-any.graph+phon.spm.npz  --type transformer \
    --train-sets ../../data/add_resources/all_text.any-any.cln.graph+phon.src ../../data/add_resources/all_text.any-any.cln.tgt  \
    --max-length 300 \
    ...
    --mini-batch-fit -w 13300 --maxi-batch 1000 \
    --early-stopping 200 \
    ...
    --log model/train_graph+phon.spm.log --valid-log model/valid.log \
