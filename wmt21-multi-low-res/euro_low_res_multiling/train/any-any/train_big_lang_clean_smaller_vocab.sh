...
$marian/marian \
	--model model/model.any-any.big.langid.smaller_vocab.npz  --pretrained-model model/model.any-any.big.smaller_vocab.npz --type transformer --task transformer-big\
    --train-sets /lnet/express/work/people/jon/wmt21/euro_low_res_multiling/data/add_resources//all_text.any-any.cln.langid_clean.src.sp /lnet/express/work/people/jon/wmt21/euro_low_res_multiling/data/add_resources//all_text.any-any.cln.langid_clean.tgt.sp  \
    --max-length 150 \
    ...
    --log model/train.big.langid.smaller_vocab.log --valid-log model/valid.log \
    --keep-best \
