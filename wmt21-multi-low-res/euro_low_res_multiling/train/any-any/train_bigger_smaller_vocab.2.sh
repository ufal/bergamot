...
$marian/marian \
	--model model/model.any-any.bigger_smaller_vocab.2.npz --pretrained-model model/model.any-any.bigger_smaller_vocab.npz  --type transformer --task transformer-big\
    ...
    --log model/train.bigger.smaller_vocab.2.log --valid-log model/valid.log \
    --keep-best \
