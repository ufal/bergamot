...
$marian/marian \
	--model model/model.ca-$tgt_lang.chars.finetune.baseline.npz --pretrained-model  model/model.ca-$tgt_lang.npz  --type transformer \
    ...
    --log model/train_chars_finetune_baseline.log --valid-log model/valid.log \
