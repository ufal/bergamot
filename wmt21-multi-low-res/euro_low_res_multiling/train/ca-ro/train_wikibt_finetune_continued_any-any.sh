...
$marian/marian \
    ...
    --train-sets ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt.ca-$tgt_lang.cln.ca.tags.anyanysp  ../../data/lang_pairs/ca-$tgt_lang/all_text+wikibt.ca-$tgt_lang.cln.$tgt_lang.anyanysp  \
    --max-length 150 \
