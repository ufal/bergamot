...
$marian/marian \
	--model model/model.ca-$tgt_lang.2.npz  --type transformer \
    --train-sets ../../data/add_resources/ca-$tgt_lang/all_text.ca-$tgt_lang.cln.ca.sp ../../data/add_resources/ca-$tgt_lang/all_text.ca-$tgt_lang.cln.$tgt_lang.sp  \
    --max-length 150 \
    --vocabs corp/vocab.2.yml corp/vocab.2.yml \
    ...
    --valid-sets corp/GlobalVoices.dev.ca-en.ca.sp corp/GlobalVoices.dev.ca-en.en.sp  \
